...
export const CONTAIN = Op.iLike; //PG only. case insensitive
export const NOT_CONTAIN = Op.notILike; //PG only. case insensitive
export const CONTAINS = Op.iLike; // alternative to CONTAIN
export const NOT_CONTAINS = Op.notILike; // alternative to NOT_CONTAIN
