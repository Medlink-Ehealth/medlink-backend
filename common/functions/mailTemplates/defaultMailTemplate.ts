...
export const defaultMailTemplate = ({ header, body, footer }: { header: string; body: string; footer?: string }) => {
	const templateRoute = resolve(path.join(root, "site", "mailTemplates", "default.txt"));
